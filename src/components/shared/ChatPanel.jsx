  ...
  return (
    <div
      ...
      style={{
        ...
        ...(user?.avatar
          ? { border: '2px solid oklch(0.46 0.15 143 / 0.25)' }
    ...
    <div className="flex flex-col h-full">
            ...
            <div className="max-w-[78%] flex flex-col gap-1">
              ...
              {msg.body && (
                <div
                  ...
                  style={msg.isMe
                    ? { background: 'oklch(0.46 0.15 143)', color: 'white', borderBottomRightRadius: msg.sameSender ? 8 : undefined }
                    : {
      ...
      >
        ...
        <button
          ...
          title="Send images"
        >
          <ImagePlus className="h-4 w-4" style={{ color: images.length > 0 ? 'oklch(0.46 0.15 143)' : (dark ? '#9ca3af' : '#6b7280') }} />
        </button>
        ...
        <textarea
          ...
          onFocus={e => { e.target.style.border = '1.5px solid oklch(0.46 0.15 143 / 0.5)'; e.target.style.boxShadow = '0 0 0 3px oklch(0.46 0.15 143 / 0.1)' }}
        ...
        <button
          ...
          style={{
            background: canSend ? 'oklch(0.46 0.15 143)' : (dark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)'),
