            ...
            {comment.likes_count > 0 && (
              <div className="flex items-center gap-0.5 text-gray-500 font-normal">
                {myReaction ? (
                  ...
                  <div className="h-[16px] w-[16px] rounded-full bg-primary flex items-center justify-center">
      ...
      <div className="bg-white dark:bg-[#242526] rounded-lg shadow p-4 space-y-4">
        ...
        {isAuthenticated ? (
          ...
          <p className="text-[15px] text-gray-500 text-center py-1">
            <Link to="/login" className="text-primary font-semibold hover:underline">Sign in</Link> to leave a comment.
          </p>
        )}
